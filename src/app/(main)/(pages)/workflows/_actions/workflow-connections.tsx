...
export const onCreateNodesEdges = async (
  ...
  try {
    ...
    const isFlow = isFlowString ? JSON.parse(isFlowString) : true;
    ...
    return { message: 'Flow updated successfully', data: updated };
  } catch (error) {
    console.error('❌ Failed to update flow:', error);
    return { error: 'Could not update nodes and edges' };
  }
};
